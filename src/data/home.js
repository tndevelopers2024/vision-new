/** Client-approved copy from Website-Content-Vision.txt. Keep wording verbatim. */

export const businessSetup = {
  "title": "Business",
  "accent": "Setup",
  "intro": "Our role goes beyond documentation—we act as strategic advisors, helping clients choose the right structure, navigate regulations, and build a strong foundation for long-term success in the UAE.",
  "options": [
    {
      "title": "UAE Mainland",
      "super": "",
...
export const ourServices = {
  ...
  "groups": [
    ...
    },
    {
      ...
      "slug": "other",
      "items": [
        "VIP Medical & Emirates ID Assistance",
...
export const ourStory = {
  ...
  "quote": "Our journey has been defined by one simple principle: putting our clients first in everything we do.",
  "paragraphs": [
    "At Vision Business Setup, we provide end-to-end business setup and corporate support services in the UAE. From company formation across Mainland, Free Zone, and Offshore jurisdictions to visa processing and PRO services, we manage the entire process with precision and efficiency. Our role goes beyond documentation—we act as strategic advisors, helping clients choose the right structure, navigate regulations, and build a strong foundation for long-term success in the UAE.",
    "Established in 2015, Vision Business Setup has grown into a trusted name in the UAE’s business setup landscape. Over the years, we have had the privilege of working with high-value clients, entrepreneurs, and well-connected business networks across the region—delivering solutions that are not only efficient, but also strategically aligned with long-term success.",
...
export const whatSetsUsApart = {
  ...
  "accent": "",
  "intro": "At Vision Business Setup, we believe that true value lies not just in delivering a service—but in how that service is delivered.",
  "cta": "Contact Us",
  "ctaHref": "/contact",
  "items": [
    {
...
export const whoWeWorkWith = {
  ...
  "accent": "",
  "intro": "Our diverse client base spans multiple industries, reflecting our ability to adapt, understand, and deliver across different business environments. We have successfully supported:",
  "items": [
    {
      "icon": "building",
  ...
  "closing": "This cross-industry experience allows us to offer practical insights and tailored strategies that go beyond standard setup services."
}
